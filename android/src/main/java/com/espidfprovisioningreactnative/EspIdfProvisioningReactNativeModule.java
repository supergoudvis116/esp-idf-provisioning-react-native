package com.espidfprovisioningreactnative;
...
@ReactModule(name = EspIdfProvisioningReactNativeModule.NAME)
public class EspIdfProvisioningReactNativeModule extends ReactContextBaseJavaModule {
    public static final String NAME = "EspIdfProvisioningReactNative";

    public EspIdfProvisioningReactNativeModule(ReactApplicationContext reactContext) {
            super(reactContext);
